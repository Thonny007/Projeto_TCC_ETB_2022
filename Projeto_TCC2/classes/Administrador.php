...
class Administrador extends Pessoa {
    ...
    public function insert(){
        ...
        try {
            ...
            echo "<script> 
                        ...
                        location.href = ('../administrador_servive/cadastro_adm.php')
                  </script>";
        } catch (Throwable $th) {
            echo "<script>
    ...
    public function delete(){
        ...
        try {
            ...
            echo "<script> 
                        alert ('⚠️⚠️ ERRO AO DELETAR ADMINISTRADOR ⚠️⚠️ ') 
                  </script>";
            echo"<script> 
                        location.href = ('../administrador_servive/lista_adm.php') 
                 </script>";
    ...
    public function atender($id, $id_clt): bool{
        $sql = "UPDATE agendamento set atendido = $id_clt where id_agnd = $id";
